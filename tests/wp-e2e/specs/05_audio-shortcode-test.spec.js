...
test.describe('Validate Audio shortcode', () => {
    ...
    test('Check Audio-shortcode', async ({ admin,page, pageUtils }) => {
        // Get short code
        await admin.visitAdminPage('upload.php');
        await page.locator('role=checkbox[name="Impact Moderato"i]').click()
        //Get input value
        ...
        await page.keyboard.type('Audio code');
        ...
        await pageUtils.pressKeyWithModifier('primary', 'a');
        await page.keyboard.press('Delete');
        await page.locator("textarea[id*='menu-item-shortcode-caption-']").nth(1).fill("Audio caption")
