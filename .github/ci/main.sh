...
######################################################
######################## VARS ########################
SITE_NAME='wp-menu-custom-field.com'
...
function create_and_configure_site () {
    ...
    mkdir wp-menu-custom-fields
    rsync -azh $GITHUB_WORKSPACE/ $SITE_ROOT/wp-content/plugins/wp-menu-custom-fields
    echo "127.0.0.1 $SITE_NAME" >> /etc/hosts
    ls
    wp plugin activate wp-menu-custom-fields --allow-root
