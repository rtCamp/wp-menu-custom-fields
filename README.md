...
## Hooks ##
#### [Filter](https://developer.wordpress.org/plugins/hooks/filters/) `wp_menu_custom_field_front_image_html` ####
...
#### Filter `wp_menu_custom_field_front_shortcode_html` ####
...
#### Filter `wp_menu_custom_field_front_custom_html_html` ####
...
#### Filter `wp_menu_custom_field_front_custom_text_html` ####
